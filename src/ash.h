...
class Ash {
    ...
    long     origTime;
    char     origName[120];
    PUFFdouble   minlat, minlon, minhgt, maxlat, maxlon, maxhgt;
...
public:
    ...
    void init_site_custom(bool multE=false, maparam* proj_grid=NULL);  
...
private:
	...
	void rotateGrid(PUFFdouble *loc, float val, ID l);
	void rotateGridPoint(PUFFdouble *loc, float val, ID l);
...
// cpu clock ticks for seeding pseudo-random generators
