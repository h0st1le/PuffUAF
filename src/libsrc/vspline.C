...
////////////////////////////////////////////////////////////////////////
// locate in a correlated list, can be up to log_2 n faster than locate
////////////////////////////////////////////////////////////////////////
...
//  static int counter = 0;
    ...
    float xwhi, xwlo, ywhi, ywlo, zwhi, zwlo, twhi, twlo,
                 pt_yhi_zhi_thi, 
                 pt_ylo_zhi_thi, 
                 pt_yhi_zlo_thi, 
                 pt_ylo_zlo_thi,
    ...
    int ilo, ihi, jlo, jhi, klo, khi, llo, lhi;
		indices(xx, yy, zz, tt, ilo, jlo, klo, llo);

//		ilo = int((xx-fgData[FRTIME].val[0])/(fgData[FRTIME].val[1]-fgData[FRTIME].val[0]));
//    hunt(fgData[FRTIME].val, fgData[FRTIME].size, xx, ilo);
...
//// levels are rarely equally spaced so fg_locate() may be better than hunt()
//    fg_locate(fgData[LEVEL].val, fgData[LEVEL].size, yy, jlo);
//    if ( jlo < 0 ) {
//	jlo = 0;
//	yy = fgData[LEVEL].val[jlo];
...
//    if ( jlo >= int(fgData[LEVEL].size-1) ) {
//	jlo = fgData[LEVEL].size-2;
//	yy = fgData[LEVEL].val[jlo+1];
//    }

//		klo = int((zz-fgData[LAT].val[0])/(fgData[LAT].val[1]-fgData[LAT].val[0]));
//    hunt(fgData[LAT].val, fgData[LAT].size, zz, klo);
...
//    if ( klo >= int(fgData[LAT].size-1) ) {
//	klo = fgData[LAT].size-2;
//	zz = fgData[LAT].val[klo+1];
//    }


//		llo = int((tt-fgData[LON].val[0])/(fgData[LON].val[1]-fgData[LON].val[0]));
//    hunt(fgData[LON].val, fgData[LON].size, tt, llo);
...
// DOES NOT WARN ON EXTRAPOLATION!
////////////////////////////////////////////////////////////////////////
float Grid::nnint(float xx, float yy, float zz, float tt, int ilo, int jlo, int klo, int llo) {
  // don't let this variable names fool you, they could be anything
//  static int counter = 0;
...
////////////////////////////////////////////////////////////////////////
// get indices, first half of nnint()
////////////////////////////////////////////////////////////////////////
void Grid::indices(float xx, float yy, float zz, float tt, 
									int &ilo, int &jlo, int &klo, int &llo)
{
